               ...
               sidebarLayout(
                 ...
                 sidebarPanel(width = 3,
                              ...
                              downloadButton("download_plot_PNG",
                                             "Download plot")),
                 mainPanel(width = 9, sidebarLayout(position = "right", fluid = TRUE,
                                                    sidebarPanel(
                                                      width = 3,
                                                    ...
                                                    mainPanel(width = 9, tabsetPanel(
                                                      tabPanel("Static Plot", br(), plotOutput("out_ggplot")),
                                                      tabPanel("Interactive Plot", br(), plotlyOutput("out_plotly"))
                                                    ))))
               )), 
      tabPanel("Code", 
               br(),
